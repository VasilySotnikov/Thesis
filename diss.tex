...
\begin{enumerate}
  \item Somewhere early define "topology"
  \item Make clear when a chapter is based on one of my papers
  \item What to do with numerical methods?
    For now it is a chapter in appendix, which probably is ok.
