...
\documentclass[oneside,a4paper,titlepage,bibliography=totoc,12pt,BCOR=17mm,DIV=12,headinclude,footinclude=false]{scrbook}
...
\usepackage[%
  pdftitle={Scattering Amplitudes with the Multi-Loop Numerical Unitarity Method},%
