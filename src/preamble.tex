...
%\ifluatex
  ...
  %\usepackage{fontenc}
%\else
  %%Packages for encoding of eg accented characters
...
\usepackage[pdftitle={NLO QCD Corrections to Vector Boson Production in Association with Multiple Heavy and Light Jets},pdfauthor={Felix Richard Anger}]{hyperref}
