...
\newcommand{\Ree}[2]{2\Re\left({#1}^{*} #2\right)}
...
\def\sket#1{\left\vert #1 \right]}
\def\sbra#1{\left[ #1 \right\vert}
\def\sbraket(#1,#2,#3){\left[ #1 \middle\vert #2 \middle\vert #3 \right\rangle}
\def\brasket(#1,#2,#3){\left\langle #1 \middle\vert #2 \middle\vert #3 \right]}
\def\spaa(#1,#2){\left\langle #1\,#2 \right\rangle}
\def\spbb(#1,#2){\left[ #1\,#2 \right]}
  %\def{\sbra#1\sket#2}{\left[ #1 #2 \right]}
