...
(\ref{eqn:defClifford}) which implies 
...
\todo{Here describe the approach of how process library does the colour decomposition. Move to main text as a short paragraph?}
