...
was has been successfully for some two-loop integrals.
However the  most  commonly used and successful method currently is to obtain analytic results via
...
some notable NNLO QCD computations have been carried out with at least part of the integrals evaluated with numerical
