...
\begin{equation*}
  \begin{array}{l|l}
    s_1 & \alpha _1^2 (1-D)+\alpha _2^2 (D-1)+\rho _1 s-2 \rho _2 s+\rho _3 s \\
    s_2 & \alpha _1^2 \left(2 D^2-5 D+3\right)+2 \alpha _1 \alpha _2 (D-1)^2+(3-2 D) \rho _1 s+(3-2 D) \rho _3 s-2 \rho _2 s \\
    s_3 & \alpha _1^2 \left(-3 D^2+7 D-4\right)+(3 D-4) \rho _1 s-2 (D-2) \rho _2 s+(3 D-4) \rho _3 s+2 \alpha _1 (D-1)^2 s \\
    s_4 & \alpha _1^2 \left(3 D^2-7 D+4\right)+(4-3 D) \rho _1 s+2 (D-2) \rho _2 s+(4-3 D) \rho _3 s+2 \alpha _2 (D-1)^2 s \\
    s_5 & -3 \alpha _1^2 \left(3 D^2-7 D+4\right)+3 (3 D-4) \rho _1 s-6 (D-2) \rho _2 s+3 (3 D-4) \rho _3 s+4 (D-1)^2 s^2 \\
  \end{array}
\end{equation*}
...
parametrized by the variables we
used in \cref{chap:stdtech,sec:ansatz_integrand}.
