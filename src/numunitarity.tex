...
but the maximal degree we need to consider in practice is always limited from above by UV behavior of the particular model under consideration.
...
linear dependences between surface terms can be found with on-shell conditions $\rho_j=0$ imposed.
...
We have constructed the master/surface basis in \cref{eq:master_surface_basis},
so to mathch the amplitude to our ansatz
\begin{equation}
