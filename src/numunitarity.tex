...
to two loops, which offers an alternative path for reduction of amplitudes and also elegantly addresses the mentioned bottlenecks.
...
but the maximal degree $\mathsf{P}$ we need to consider in practice is always limited from above by UV behavior of the particular model under consideration.
...
For $L=2$ we have 11 scalar products. There are 3 propagators in the sunrise, so we have 8 ISPs \todo{clarify including transverse} in total.
...
\todo{clarify it's the central equation} 
